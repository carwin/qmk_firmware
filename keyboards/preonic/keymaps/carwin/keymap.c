...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, KC_F11,  KC_F12,  KC_UNDS,   KC_EQL,  KC_LBRC, KC_RBRC, _______,
 ...
 * | Del  |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   -  |   =  |   [  |   ]  |  \   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |   _k |ISO / | Pg Up| Pg Dn|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______,  _______, _______, _______, KC_AGIN, _______, _______, _______,  _______, _______, _______, _______,
  _______,  _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______,
  _______,  KC_UNDO, _______, _______, _______, _______, KC_MUTE, _______,  _______, _______, _______, KC_MPLY,
